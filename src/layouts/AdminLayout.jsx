...
import {
  ...
  BarChart3, LogOut, Menu, X, Code2, Bell, Settings,
...
function SidebarShell({ links, roleLabel, children }) {
  ...
  return (
    <div className="flex h-screen bg-surface overflow-hidden">
      <aside className={`${sidebarOpen ? 'w-64' : 'w-16'} transition-all duration-300 flex-shrink-0 flex flex-col bg-surface-card border-r border-surface-border overflow-hidden`}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="h-16 flex items-center justify-between px-6 border-b border-surface-border bg-surface-card flex-shrink-0">
          <div className="flex items-center gap-4">
            <button onClick={() => dispatch(toggleSidebar())} className="btn-ghost p-2">
